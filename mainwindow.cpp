...
void MainWindow::ProcesarVideo(bool checked){
    ...
    cv::Ptr< cv::cuda::CascadeClassifier> face_cascade = cuda::CascadeClassifier::create(QString("/home/riclab/Documentos/opencv/haar_classifier.xml").toStdString().c_str());
